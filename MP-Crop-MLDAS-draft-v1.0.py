...
#python3 ./MP-EnKF-draft-v1.2.py &>nohup.out&
...
for ii in range(0,istep):
    ...
    if ii==0:
        ...
        # for the first time step, we should generate ensemble of restart file and MPtable
        # Open restart file and read state variables
    ...
    if ii==0:
        vcmax25_num=round(100.0,1)##保留小数点位数
